...
Для просмотра необходима авторизация пользователя.
Существет возможность просмотра фото в отдельном окне в высоком качестве, а также масштабирование отдельных участков (мультитач - сведение/разведение пальцев).
На фото можно добавлять и убирать лайки.
...
[Макет Figma](https://www.https://tinyurl.com/image-feed-figma.com/file/l0IMG3Eys35fUrbvArtwsR/YP-Quiz?node-id=34%3A243)
...
3. В приложении используются стандартные шрифты - SF Pro;
4. Для хранения токена используется KeyChain;
5. Архитектура приложения MVP;
6. Верстка сторибордом и кодом.
